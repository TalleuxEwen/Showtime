...
class IScene
{
  public:
     ...
     * @param clientCore
     */
    explicit IScene(ClientCore *clientCore, std::shared_ptr<AudioEngine> audioEngine) :
        _clientCore(clientCore), _engine(std::move(audioEngine))
    {
    }
  ...
  protected:
    ...
    timeval _pingTime{};
    std::shared_ptr<AudioEngine> _engine;
};
